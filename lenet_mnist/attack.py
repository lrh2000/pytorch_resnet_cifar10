...
pretrained_model = "../models/model1.pt"
pretrained_model2 = "../models/model2.pt"
use_cuda = True
...
def fgsm_attack(image, epsilon, data_grad):
    ...
    sign_data_grad = (torch.rand_like(data_grad) - 0.5).sign()
...
for eps in epsilons:
    acc, ex = test(model, model2, device, test_loader, eps)
